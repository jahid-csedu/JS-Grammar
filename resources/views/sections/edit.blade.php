        ...
        <div class="form-group row">
            ...
            <select id="class" name="class" class="form-control col-sm-9" required>
                @foreach($classes as $class)
                    @if($class->name_english === $section->class)
        ...
        <div class="form-group row">
            ...
            <select id="shift" name="shift"class="form-control col-sm-9" required>
                @switch($section->shift)
                    @case("Morning-1")
                        <option selected>Morning-1</option>
                        <option>Morning-2</option>
                        <option>Day</option>
                    @break
                    @case("Morning-2")
                        <option>Morning-1</option>
                        <option selected>Morning-2</option>
                        <option>Day</option>
                    @break
                    @case("Day")
                        <option>Morning-1</option>
